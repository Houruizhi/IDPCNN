...
def process_fastMRI(data_path, out_path, sampling_rate=1.):
    ...
    for _, file_ in tqdm(enumerate(files)):
        ...
        with h5py.File(file_, 'r') as hf:
            ...
            for slice_i in range(5, num_slices):
...
def process_SIAT(IMG_PATH, save_path):
    import scipy.io
...
if __name__ == '__main__':
    # split_dataset('/home/rzhou/DataSets/MRI/IXI-T1')
    ...
    process_fastMRI('/home/rzhou/local/MRIDatasets/knee_singlecoil_train/singlecoil_train', '/home/rzhou/ssd_cache/fastMRI_npy/singlecoil_train_wo_normalize')
    process_fastMRI('/home/rzhou/local/MRIDatasets/knee_singlecoil_train/singlecoil_val', '/home/rzhou/ssd_cache/fastMRI_npy/singlecoil_val_wo_normalize', 0.06)
    ...
    # process_SIAT('/home/rzhou/local/SIAT/train', '/home/rzhou/ssd_cache/SIAT/train')
    # process_SIAT('/home/rzhou/local/SIAT/test', '/home/rzhou/ssd_cache/SIAT/test')
